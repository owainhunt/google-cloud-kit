...
class IAMServiceAccountCredentialsRequest: GoogleCloudAPIClient {
    ...
    func send<T: Codable>(
        ...
        guard (200...299).contains(response.status.code) else {
            do {
                throw try decoder.decode(IAMServiceAccountCredentialsAPIError.self, from: responseData)
            } catch {
                throw IAMServiceAccountCredentialsAPIError(
                    error: IAMServiceAccountCredentialsAPIErrorBody(
                        status: "unknown",
