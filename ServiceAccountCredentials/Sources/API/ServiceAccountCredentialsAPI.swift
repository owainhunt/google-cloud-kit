...
public protocol ServiceAccountCredentialsAPI {
...
public extension ServiceAccountCredentialsAPI {
...
public final class GoogleCloudServiceAccountCredentialsAPI: ServiceAccountCredentialsAPI {
    let endpoint: String
    let request: GoogleCloudServiceAccountCredentialsRequest
    
    init(request: GoogleCloudServiceAccountCredentialsRequest, endpoint: String) {
