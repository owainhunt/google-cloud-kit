...
public enum GoogleCloudServiceAccountCredentialsError: GoogleCloudError {
...
public struct ServiceAccountCredentialsAPIError: GoogleCloudError, Codable {
    /// A container for the error information.
    public var error: ServiceAccountCredentialsAPIErrorBody
}

public struct ServiceAccountCredentialsAPIErrorBody: Codable {
...
public struct ServiceAccountCredentialsError: Codable {
