...
public final class GoogleCloudStorageObjectAPI: StorageObjectAPI {
    ...
    public func compose(
        ...
        return try await request.send(method: .POST,
                                      path: "\(endpoint)/\(bucket)/o/\(destinationObject.replacingOccurrences(of: "/", with: "%2F")))/compose",
                                      query: queryParams,
    ...
    public func copy(
        ...
        return try await request.send(method: .POST,
                                      path: "\(endpoint)/\(sourceBucket)/o/\(sourceObject.replacingOccurrences(of: "/", with: "%2F")))/copyTo/b/\(destinationBucket)/o/\(destinationObject.replacingOccurrences(of: "/", with: "%2F")))",
                                      query: queryParams,
                                      body: .bytes(.init(data: requestBody)))
    }
    ...
    public func delete(
        ...
        return try await request.send(method: .DELETE, path: "\(endpoint)/\(bucket)/o/\(object.replacingOccurrences(of: "/", with: "%2F")))", query: queryParams)
    }
    ...
    public func get(
        ...
        return try await request.send(method: .GET, path: "\(endpoint)/\(bucket)/o/\(object.replacingOccurrences(of: "/", with: "%2F")))", query: queryParams)
    }
    ...
    public func update(
        ...
        return try await request.send(method: .PUT,
                                      path: "\(endpoint)/\(bucket)/o/\(object.replacingOccurrences(of: "/", with: "%2F")))",
                                      query: queryParams,
                                      body: .bytes(.init(data: requestBody)))
    }
